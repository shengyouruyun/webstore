...
import com.packet.webstore.interceptor.ProcessingTimeLogInterceptor;
...
import com.packt.webstore.validator.*;
...
public class WebApplicationContextConfig extends WebMvcConfigurerAdapter{
	...
	//add json and xml view in web app config 
	@Bean
	...
	public ProductValidator productValidator(){
		...
		productImageValidator.setAllowedSize(15000);
